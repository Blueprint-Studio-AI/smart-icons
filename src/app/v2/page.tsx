...
export default function Home() {
  ...
  const getSmallText = (selectedRow: TableRow | null): string | null => {
    ...
    if (selectedRow.age >= 21 && selectedRow.event.includes("Expired") && selectedRow.bcdStatus === "Disabled") return "Fake ID Detection Disabled";
    
    // When Age > 21 and Expired and BCD Status is Disconnected
    if (selectedRow.age >= 21 && selectedRow.event.includes("Expired") && selectedRow.bcdStatus === "Disconnected") return "Fake ID Detection Off";
    ...
    if (selectedRow.bcdStatus === "Disabled") return "Fake ID Detection Disabled";
    
    // When BCD Status is Disconnected
    if (selectedRow.bcdStatus === "Disconnected") return "Fake ID Detection Off";
      ...
      <div className="w-1/2 p-3 bg-gray-50 flex flex-col">
        ...
        {selectedRow ? (
          ...
          <div className="p-2 bg-white rounded border text-xs mb-3 text-center text-gray-500">
            <p>Click a row to display details</p>
          </div>
        )}
